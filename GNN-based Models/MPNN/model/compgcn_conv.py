...
class CompGCNConv(MessagePassing):
	...
	def forward(self, x, edge_index, edge_type, rel_embed): 
		...
		#print("x:", x.size())
		#print("rel_embed:", rel_embed.size())
		#print("rel_embed and loop_rel:", rel_embed.size(), self.loop_rel.size())
		rel_embed = torch.cat([rel_embed, self.loop_rel], dim=0) # rel_embed and loop_rel: torch.Size([22, 100]) torch.Size([1, 100])
		...
		#print("rel_embed!!!:", rel_embed.size()) # torch.Size([23, 100])
		...
		out = self.bn(out)
		out = self.act(out)
		#xxx = torch.matmul(rel_embed, self.w_rel)[:-1]
		#print("xxx!!!!!:", xxx.size()) torch.Size([22, 200])
		#print("out size is:", out.size()) # out size is: torch.Size([40943, 200])
	...
	def rel_transform(self, ent_embed, rel_embed):
		print("previous ent_embed and rel_embed:", ent_embed.size(), rel_embed.size(), self.p.opn)
		...
		print("ent_embed and rel_embed:", ent_embed.size(), rel_embed.size(), trans_embed.size())
		return trans_embed

	def message(self, x_j, edge_type, rel_embed, edge_norm, mode):
		weight 	= getattr(self, 'w_{}'.format(mode))
		print("weight in message:", weight.size())
		rel_emb = torch.index_select(rel_embed, 0, edge_type)
		print("input rel_embed!!!:", rel_embed.size())
